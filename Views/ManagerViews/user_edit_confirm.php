...
<html lang="ja">
  ...
  <div class="wrapper">
    ...
    <div class="conf_text">
        ...
        <!-- <div class="result">
        <p class="left_text">FriendsID　　　：</p><p class="right_text"><?=$user_unique_id?></p>
        </div> -->
        <div class="result">
        <p class="left_text">ユーザー　　　：</p><p class="right_text">
          <?php if($_SESSION['frole'] == 1):?>
            <?php echo '管理者';?>
            <?php else:?>
            <?php echo '一般';?> 
            <?php endif;?>
        ...
        <input type="submit" value="はい" onclick="location.href='user_edit_complete.php?user_unique_id=<?=$_SESSION['user_unique_id']?>'" class="yes btn btn-success">  <button type="button" onclick="history.back()" class="back btn btn-secondary">戻る</button>
